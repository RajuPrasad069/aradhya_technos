...
import 'package:aradhya_techno/Views/D.P.M.dart';
import 'package:aradhya_techno/Views/home_page.dart';
import 'package:aradhya_techno/Views/search_screen.dart';
import 'package:aradhya_techno/Views/training_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import '../big_faction.dart';
import 'custom_nav_bar.dart';

class CustomTabBarView extends StatefulWidget {
  final int index;

  const CustomTabBarView({Key? key, required this.index}) : super(key: key);
